...
export const INITIAL_RESEARCH_STATE = Object.freeze({
  p: 0.78,
  m: 0.72,
  psi: 1.35
});
...
export const clamp01 = (value) => Math.min(1, Math.max(0, finite(value, "state")));
...
export function metricConstraintMargins(state) {
...
export class ResearchStateStore {
  ...
  constructor(initial = INITIAL_RESEARCH_STATE) {
