...
BLUE="#6cb6ff"; TEAL="#4ec9b0"; VIOLET="#c6a0f6"; GREEN="#8bd450"; SKY="#87CEFA"; CORAL="#ff9f7a"; LINE="#31516a"
...
def figure_F08():
    ...
    for t in [2.3, 8.5, 15.5, 22.5]:
        ...
        for vec,col,label,dy in [(T,TEAL,"T",0),(N,CORAL,"N",22),(B,SKY,"B",-22)]:
            q=add3(p,vec,0.62)
    ...
    parts.append(text(1735,725,f"τ = a/(1+a²) = {tau:.6f}",28,SKY,700,family="ui-monospace,Menlo,monospace"))
    ...
    parts.append(text(1735,1090,"curve = blue",25,BLUE)); parts.append(text(1735,1135,"tangent = teal",25,TEAL)); parts.append(text(1735,1180,"normal = coral",25,CORAL)); parts.append(text(1735,1225,"binormal = sky blue",25,SKY))
...
def figure_F11():
    ...
    for shift,col in [(0,TEAL),(2.1,BLUE),(4.2,SKY)]: sols.append((rk4_geodesic(th0,ph0+shift,td,pd,7.0,.0125),col))
...
def heat_color(value):
    z=max(-1,min(1,value)); return mix_hex("#122941",BLUE,-z) if z<0 else mix_hex("#122941",SKY,z)
